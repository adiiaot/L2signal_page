    ...
    <section id="roadmap" className="max-w-6xl mx-auto px-4 py-6 scroll-reveal">
      <div className="card">
        ...
        <div className="mt-4 grid md:grid-cols-4 gap-3">
          {STEPS.map(s => (
            <div key={s.phase} className="rounded-xl p-4 relative overflow-hidden" style={{ background: s.done ? 'rgba(var(--accent-gold-rgb),0.08)' : 'rgb(var(--surface-overlay-rgb))', border: `1px solid ${s.done ? 'rgba(var(--accent-gold-rgb),0.2)' : 'var(--glass-border)'}` }}>
